...
function Header() {
  return (
    <header className="relative p-16 text-center">
        <Link href="/">
        <h1 className="text-6xl font-black">Storyteller Bot</h1>
        <div className="flex justify-center whitespace-nowrap space-x-5 text-3xl lg:text-5xl">
            ...
            <div className="absolute -top-5 right-5 flex space-x-2">
                <Link href="/">
                <FilePen className="w-8 h-8 lg:w-10 lgh-10 mx-auto text-purple-500 mt-10 border border-purple-500 p-2 rounded-md hover:opacity-50 cursor-pointer"/></Link>
                <Link href="/stories">
                <BookOpen className="w-8 h-8 lg:w-10 lgh-10 mx-auto text-purple-500 mt-10 border border-purple-500 p-2 rounded-md hover:opacity-50 cursor-pointer"/></Link>
            </div>
    </header>
  )
}
